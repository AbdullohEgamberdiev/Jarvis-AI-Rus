...
recognition.onresult = function (event) {
  ...
  if (transcript.includes("тебе нравится твоё имя")){
    readOut("конечно, мне нравится мое имя")
  }
  ...
  if (transcript.includes("сколько языков ты знаешь") || transcript.includes("сколько языков")){
  ...
  if (transcript.includes("знаешь английский")){
    readOut("конечно, моя английская версия знает")
  }

  if (transcript.includes("как дела") || transcript.includes("как вы") || transcript.includes("как ты")){
    readOut("я в порядке, сэр, и вы")
  }
  if (transcript.includes("как я могу получить вашу английскую версию") || transcript.includes("вашу английскую версию")){
    readOut("во-первых, ты должен его купить")
  }
  if (transcript.includes("как я могу это купить") || transcript.includes("как я могу купить это")){
    readOut("тебе нужно связаться с моим владельцем")
  }
  if (transcript.includes("и сколько это стоит") || transcript.includes("сколько это стоит")){
    readOut("Точно не знаю, но около 30 долларов.")
  }
  if (transcript.includes("это дорого")){
    readOut("оно заслуживает этой цены.")
  }
  ...
  if (transcript.includes("у меня нет друзей") || transcript.includes("у меня нет друга") || transcript.includes("нет друзей")){
    readOut("это нехорошо, можешь считать меня своим другом")
  }
  if (transcript.includes("иди к чёрту")){
    readOut("это не красиво, уходи отсюда")
  }
  if (transcript.includes("ты серьезно") || transcript.includes("ты серьёзно")){
    readOut("конечно мой друг")
  }
  if (transcript.includes("у тебя есть мозг")){
    readOut("да конечно, у меня есть мозг и он умнее некоторых людей")
  }
  ...
  if (transcript.includes("что-нибудь сделать") || transcript.includes("можем ли что-нибудь сделать")){
  ...
  if (transcript.includes("что ты знаешь о железном человеке") || transcript.includes("дайте мне немного информации о железном человеке") || transcript.includes("железном человеке")){
  ...
  if (transcript.includes("что такое искусственный интеллект") || transcript.includes("искусственный интеллект")){
  ...
  if (transcript.includes("ты снимался") || transcript.includes("ты снимался в каком-нибудь фильме")){
    readOut("да сэр, я играл во всех фильмах о Железном человеке")
  }
  if (transcript.includes("что означает твоя имя") || transcript.includes("значение твоего имени") || transcript.includes("что означает твоя имя") || transcript.includes("что означает твоё имя")){
    readOut("Nova - звезда, демонстрирующая внезапное резкое увеличение яркости, а затем медленно возвращающаяся в исходное состояние в течение нескольких месяцев.")
  }
  ...
  if (transcript.includes("автомобильную игру")){
